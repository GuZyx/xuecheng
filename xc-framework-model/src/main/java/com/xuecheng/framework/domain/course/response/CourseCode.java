...
public enum CourseCode implements ResultCode {
    ...
    COURSE_PUBLISH_PICISNULL(false,31004,"图片Id为空！"),
    COURSE_PUBLISH_VIEWERROR(false,31005,"发布课程视图出错！"),
    COURSE_ISNULL(false,31006,"查找不到课程！"),
    COURSE_PICISNULL(false,31006,"查找不到课程图片！"),
    COURSE_MARKETISNULL(false,31006,"查找不到课程营销信息！"),
    COURSE_TEACHPLANISNULL(false,31006,"查找不到课程计划！"),
    COURSE_MEDIA_TEACHPLAN_ISNULL(false,31107,"课程计划关联媒资找不到！"),
